...
# Public: Supported version formats
...
# Private: Verbose flag
__DAQ_VERSION_VERBOSE=0

# Private: Match result variables (initialized to avoid unset variable errors)
__MATCH_PREFIX=""
__MATCH_MAJOR=""
__MATCH_MINOR=""
__MATCH_PATCH=""
...
# Private: Regex pattern for version matching
